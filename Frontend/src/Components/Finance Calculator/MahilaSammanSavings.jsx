...
const MahilaSammanSavings = () => {
  const [futureAmount, setFutureAmount] = useState(null);

  function showFutureAmount() {
    const amount = document.getElementById("mahila_amount").value;
    ...
    if (cost > 200000 != 0) {
      toast.error("Amount should be less than Rs. 2 lakhs");
      return;
    }

    setFutureAmount(calculateCompoundInterest(cost));
  }
  ...
  function calculateCompoundInterest(
    ...
    for (let i = 0; i < totalQuarters; i++) {
      deposit += deposit * quarterlyInterestRate;
    }
                        ...
                        <div>
                          ...
                          <p className="flex justify-between">
                            ...
                            <span className="text-base">
                              Rs.{" "}
                              {parseFloat(
                                document.getElementById("mahila_amount").value
                              ).toFixed(2)}
                            </span>
                          </p>
                          <p className="flex justify-between">
...
export default MahilaSammanSavings;
