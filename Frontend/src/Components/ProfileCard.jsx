  ...
  return (
    <div>
      <div className="flex items-center justify-center min-h-screen from-gray-700 via-gray-800 to-gray-900 bg-gradient-to-br">
        <div className="px-8">
          <div className="relative w-full flex group max-w-md min-w-0 mx-auto mt-6 mb-6 break-words bg-white border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl">
            <div className="pb-6">
              <div className="flex flex-wrap justify-center">
                <div className="flex justify-center w-full">
                  <div className="relative">
                    <img
                      src="https://media.licdn.com/dms/image/D5603AQGLVuTd7hi6hA/profile-displayphoto-shrink_800_800/0/1706547936639?e=1724889600&v=beta&t=diirLaakuxgCj_LxogAlRpDji7jNo5F-YeiTJxbS630"
                ...
                <div className="flex flex-wrap justify-center">
                  <div className="w-full px-6">
                    <p className="mb-4 font-light leading-relaxed text-gray-600 dark:text-gray-400">
                      B.tech Electrical Engineering Student at Indian Institute
                      of Technology, Jodhpur. A technology enthusiast who is
            ...
            <div className="pb-6">
              <div className="flex flex-wrap justify-center">
                <div className="flex justify-center w-full">
                  <div className="relative">
                    <img
                      src="https://media.licdn.com/dms/image/D4D03AQGGuvKxrq-j8Q/profile-displayphoto-shrink_800_800/0/1670087467867?e=1724889600&v=beta&t=N9eTZYcG8YAZjDavE8pHPK-GGG7HB7dv3uogoz7cClM"
                      className="dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]"
                    />
                  </div>
                </div>
                ...
                <div className="w-full text-center">
                  <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                    <div className="flex space-x-2">
                      ...
                      <a
                        className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                        href="https://www.linkedin.com/in/tushar-bhatt-6031a5253/"
                        rel="noopener"
                        aria-label="Ariel Cerda on Linkedin"
                        target="_blank"
                      >
              ...
              <div className="pt-6 mx-6 mt-6 text-center border-t border-gray-200 dark:border-gray-700/50">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full px-6">
                    <p className="mb-4 font-light leading-relaxed text-gray-600 dark:text-gray-400">
                      B.tech Computer Science Engineering student at Indian
                      Institute of Technology, Jodhpur. A technology enthusiast,
                      who loves to learn more and grow everyday. Experience in
